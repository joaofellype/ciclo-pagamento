...
class ItemList extends Component {
    ...
    renderRows(){
        ...
        return list.map((item,index)=>(
            ...
            <td><Field name={`${this.props.field}[${index}].value`} placeholder="Informe o Valor" readOnly={this.props.readOnly}component={Input} /></td>
            <If test={this.props.showStatus}>
            <td><Field name={`${this.props.field}[${index}].status`} placeholder="Informe o Status" type="select" readOnly={this.props.readOnly} component={Input} /></td>
            </If >
            <td>
